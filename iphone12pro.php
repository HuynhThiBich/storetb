...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
                <li class="nav-item active">
                    <a class="nav-link active" href="index.php"> <i class="fa fa-home" aria-hidden="true"></i> TRANG CHỦ <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="gioithieu.php"><i class="fa fa-users" aria-hidden="true"></i> GIỚI THIỆU</a>
                </li>
    ...
    <div style="background: none;" class="container  homepage">
        ...
        <div class="row" id="dienthaoi">
            <div class="col-md-12 bgcolorcolmd12pro text-center">
                <h2 class="display-4 font-weight-bold mt-2">iPhone 12 Pro | 12 Pro Max </h2>
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 4,400,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro 128GB
                                    chính hãng (VN/A)</a></h5>
                            <h5 style="color: red;">26.590.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>30.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 6,500,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro 256GB
                                    chính hãng (VN/A)</a></h5>
                            <h5 style="color: red;">28.490.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>34.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>8.547.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="dondathang.php" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/iphone-12-l3-promax-didongviet.jpg" class="card-img-top img-fluid"
                            alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                            ...
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 128GB
                                    chính hãng (VN/A)</a></h5>
                            <h5 style="color: red;">28.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>33.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>8.697.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="dondathang.php" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 6,000,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 256GB
                                    chính hãng (VN/A)</a></h5>
                            <h5 style="color: red;">31.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>37.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>9.597.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="dondathang.php" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 8,500,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 512GB
                                    chính hãng (VN/A)</a></h5>
                            <h5 style="color: red;">32.490.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>40.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>9.747.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="dondathang.php" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 4,00,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 128GB
                                    chính hãng (VN/A) (TBH)</a></h5>
                            <h5 style="color: red;">26.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>30.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>7.977.000<sup><ins>đ</ins></sup></span>
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 8,000,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 256GB
                                    chính hãng (VN/A) (TBH)</a></h5>
                            <h5 style="color: red;">29.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>37.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>7.977.000<sup><ins>đ</ins></sup></span>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 5,400,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">iPhone 12 Pro Max 256GB
                                    chính hãng (TBH)</a></h5>
                            <h5 style="color: red;">25.590.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>30.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>7.977.000<sup><ins>đ</ins></sup></span>
