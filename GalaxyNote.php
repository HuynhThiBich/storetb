        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link " href="dangnhap.html" tabindex="-1" aria-disabled="true">Đăng nhập</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div style="background: none;" class="container  homepage">
        ...
        <div class="row">
            <div class="col-md-12 bgcolorcolmd12pro text-center">
                <h2 class="display-4 font-weight-bold mt-2">Galaxy Note</h2>
            </div>
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/samsung-galaxy-note-20-8gb-256gb_1_3.jpg" class="card-img-top img-fluid" alt="">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 9,000,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Note 20
                                    (8GB|256GB)</a></h5>
                            <h5 style="color: red;">14.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>23.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>4.497.000<sup><ins>đ</ins></sup></span>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/samsung-galaxy-note-2020-ultra_2_1_1_4_1.jpg" class="card-img-top img-fluid"
                            alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 3,000,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Note 20
                                    Ultra (8GB|256GB)</a></h5>
                            <h5 style="color: red;">26.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>29.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>8.097.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/galaxy-s21-ultra-5g-black-didongviet.jpg" class="card-img-top img-fluid"
                            alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 3,600,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Note 20
                                    Ultra (12GB|256GB)</a></h5>
                            <h5 style="color: red;">29.390.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>32.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>8.817.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 11,700,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Note 20
                                    Ultra (12GB|256GB)</a></h5>
                            <h5 style="color: red;">21.290.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>32.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>6.387.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 9,200,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Note 20
                                    (8GB|256GB)</a></h5>
                            <h5 style="color: red;">14.790.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>23.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>4.437.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
