...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand textnav" href="trangchu.php">TB PHONE</a>
    ...
    <div style="background: none;" class="container  homepage">
        ...
        <div class="row">
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/fold.png" class="card-img-top img-fluid" alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            ...
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Z Fold2
                                    5G</a></h5>
                            <h5 style="color: red;">47.000.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>50.000.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>14.097.000<sup><ins>đ</ins></sup></span>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/gafold.jpg" class="card-img-top img-fluid" alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 3,010,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy Z Fold2
                                    5G</a></h5>
                            <h5 style="color: red;">46.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>50.000.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>14.097.000<sup><ins>đ</ins></sup></span>
